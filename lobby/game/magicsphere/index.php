...
<title>Слот автомат Магический Шар</title>

<script language="JavaScript" type="text/javascript">
<!--
window.status="Слот автомат Магический Шар";
//-->
</script>
...
<OBJECT classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000"
 ...
 WIDTH="100%" HEIGHT="100%" id="index">
	<PARAM NAME="movie" VALUE="140106.swf">
	<PARAM NAME="FlashVars" VALUE="l=<? echo $l; ?>">
	<PARAM NAME="quality"   VALUE="high">
	<PARAM NAME="bgcolor"   VALUE="#0B2A40">
	<PARAM NAME="menu"      VALUE="true">
	<EMBED src="140106.swf" quality=high bgcolor="#0B2A40" FlashVars="l=<? echo $l; ?>" WIDTH="100%" HEIGHT="100%" NAME="index"
