...
<title>Слот-автомат "Слот автомат ХЭЛЛОУИН"</title>

<script language="JavaScript" type="text/javascript">
<!--
window.status="Слот-автомат 'ХЭЛЛОУИН'";
//-->
</script>
</HEAD>
...
<OBJECT classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000"
 ...
 WIDTH="100%" HEIGHT="100%" id="index">
	<PARAM NAME="movie" VALUE="hallowen.swf">
	<PARAM NAME="FlashVars" VALUE="l=<? echo $l; ?>">
	<PARAM NAME="quality"   VALUE="high">
	<PARAM NAME="bgcolor"   VALUE="#000000">
	<PARAM NAME="menu"      VALUE="true">
	<EMBED src="hallowen.swf" quality=high bgcolor="#000000" FlashVars="l=<? echo $l; ?>" WIDTH="100%" HEIGHT="100%" NAME="index"
