...
<title>Слот-автомат "Слот автомат АРИСТОКРАТ"</title>

<script language="JavaScript" type="text/javascript">
<!--
window.status="Слот-автомат 'Аристократ'";
//-->
</script>
</HEAD>
...
<OBJECT classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000"
 ...
 WIDTH="100%" HEIGHT="100%" id="index">
	<PARAM NAME="movie" VALUE="aristo.swf">
	<PARAM NAME="FlashVars" VALUE="l=<? echo $l; ?>">
	<PARAM NAME="quality"   VALUE="high">
	<PARAM NAME="bgcolor"   VALUE="#000000">
	<PARAM NAME="menu"      VALUE="true">
	<EMBED src="aristo.swf" quality=high bgcolor="#000000" FlashVars="l=<? echo $l; ?>" WIDTH="100%" HEIGHT="100%" NAME="index"
