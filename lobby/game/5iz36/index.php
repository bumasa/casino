...
<title>Лотерея 5 из 36</title>

<script language="JavaScript" type="text/javascript">
<!--
window.status="Лотерея 5 из 36";
//-->
</script>
</HEAD>
...
<OBJECT classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000"
 ...
 WIDTH="100%" HEIGHT="100%" id="index">
	<PARAM NAME="movie" VALUE="my_loto.swf">
	<PARAM NAME="quality"   VALUE="high">
	<PARAM NAME="bgcolor"   VALUE="#000000">
	<PARAM NAME="menu"      VALUE="true">
	<EMBED src="my_loto.swf" quality=high bgcolor="#0B2A40" FlashVars="l=<? echo $l; ?>" WIDTH="100%" HEIGHT="100%" NAME="index"
