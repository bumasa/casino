...
echo "<center>";
  ...
  echo "<table cellpadding=\"0\" cellspacing=\"0\" border=\"0\" height=\"100%\" width=\"100%\">"
      ...
      ."<PARAM VALUE=\"LottoKeno.swf?URL_SERVLET=/lobby/game/LottoKeno/game.php&URL_REDIRECTOR=/lobby/game/LottoKeno/index.php&REAL=1&HelpURL=javascript:helpwnd('LottoKeno')\" NAME=\"movie\">"
      ."<PARAM VALUE=\"false\" NAME=\"menu\">"
      ."<PARAM VALUE=\"best\" NAME=\"quality\">"
      ."<PARAM VALUE=\"#0B2A40\" NAME=\"bgcolor\">"
      ."<EMBED PLUGINSPAGE=\"http://www.macromedia.com/shockwave/download/index.cgi?P1_Prod_Version=ShockwaveFlash\" TYPE=\"application/x-shockwave-flash\" WIDTH=98% HEIGHT=98% bgcolor=\"#0B2A40\" devicefont=\"true\" quality=\"best\" menu=\"false\" name=\"Flash\" src=\"LottoKeno.swf?URL_SERVLET=/lobby/game/LottoKeno/game.php&URL_REDIRECTOR=/lobby/game/LottoKeno/index.php&REAL=1&HelpURL=javascript:helpwnd('LottoKeno')\"></EMBED>"
      ."</OBJECT>"
      ."</td>"
      ."</tr>"
      ."</table>";
...
echo "</center>"
  ...
  case "ERROR":
  header("Location: /lobby/game/LottoKeno/index.php");
  break;
