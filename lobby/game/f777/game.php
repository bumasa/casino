...
if ($bar1==7 && $bar2==7){ $win=$bet*1; }
if ($bar1==10){ $win=$bet*2; }
if ($bar1==10 && $bar2==7 && $bar3==7){ $win=$bet*3; }
if ($bar1==10 && $bar2==10){ $win=$bet*5; }
if ($bar1==7 && $bar2==10 && $bar3==7){ $win=$bet*7; }
if ($bar1==2 && $bar2==2 && $bar3==2){ $win=$bet*10; }
if ($bar1==3 && $bar2==3 && $bar3==3){ $win=$bet*10; }
if ($bar1==4 && $bar2==4 && $bar3==4){ $win=$bet*10; }
if ($bar1==5 && $bar2==5 && $bar3==5){ $win=$bet*10; }
if ($bar1==6 && $bar2==6 && $bar3==6){ $win=$bet*10; }
if ($bar1==8 && $bar2==8 && $bar3==8){ $win=$bet*10; }
if ($bar1==10 && $bar2==10 && $bar3==10){ $win=$bet*20; }
if ($bar1==1 && $bar2==1 && $bar3==1){ $win=$bet*50; }
if ($bar1==9 && $bar2==9 && $bar3==9){ $win=$bet*100; }
if ($bar1==7 && $bar2==7 && $bar3==7){ $win=$bet*200; }
...
$date=date("d.m.y");
$time=date("H:i:s");
$sqls="INSERT INTO stat_game VALUES('NULL','$date','$time','$l','$row[3]','$bet','$win','777')";
mysql_query($sqls);
