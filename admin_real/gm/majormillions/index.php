...
if ($send == "1") {
$send="";
mysql_query("update g_set_new set g_bank=$g_bank where g_name='majormillions'");
mysql_query("update g_set_new set g_proc=$g_proc where g_name='majormillions'");
echo "<script> alert('Настройки сохранены!'); document.location.href='index.php';</script>";
}

if ($send == "2") {
$send="";
mysql_query("update g_set_new set g_rezim=$g_rezim where g_name='majormillions'");
echo "<script> alert('Настройки сохранены!'); document.location.href='index.php';</script>";
}
...
mysql_query("update g_set_new set g_shansbon='$g_shansbon' where g_name='majormillions'");
mysql_query("update g_set_new set g_shanswin='$g_shanswin' where g_name='majormillions'");
mysql_query("update g_set_new set g_rezerv='$g_shansdouble' where g_name='majormillions'");
echo "<script> alert('Настройки сохранены!'); document.location.href='index.php';</script>";
}
...
<html>
<head>
<title>Настройка игры majormillions</title>
...
<center><b>Настройка игры majormillions</b><br><a href=../../index.php> << Вернуться в админку </a><br><br></center>
...
<TR><TD align="left">Бонус врашения : </td><td align="right">1 из <INPUT maxLength=20 size=10 name=g_shansbon1 value="<?echo $g_shansbon1;?>" style=" border: 1px solid rgb(0,0,0)"> min 2 </TD></TR>
<TR><TD align="left">Колич. врашения : </td><td align="right">1 из <INPUT maxLength=20 size=10 name=g_shansbon2 value="<?echo $g_shansbon2;?>" style=" border: 1px solid rgb(0,0,0)"> min 2 </TD></TR>
