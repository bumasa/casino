...
if ($send == "1") {
$send="";
mysql_query("update g_set_new set g_bank=$g_bank where g_name='whathoot'");
mysql_query("update g_set_new set g_proc=$g_proc where g_name='whathoot'");
echo "<script> alert('Настройки сохранены!'); document.location.href='index.php';</script>";
}

if ($send == "2") {
$send="";
mysql_query("update g_set_new set g_rezim=$g_rezim where g_name='whathoot'");
echo "<script> alert('Настройки сохранены!'); document.location.href='index.php';</script>";
}
...
mysql_query("update g_set_new set g_shansbon='$g_shansbon' where g_name='whathoot'");
mysql_query("update g_set_new set g_shanswin='$g_shanswin' where g_name='whathoot'");
mysql_query("update g_set_new set g_rezerv='$g_shansdouble' where g_name='whathoot'");
echo "<script> alert('Настройки сохранены!'); document.location.href='index.php';</script>";
}
...
<html>
<head>
<title>Настройка игры whathoot</title>
...
<center><b>Настройка игры whathoot</b><br><a href=../../index.php> << Вернуться в админку </a><br><br></center>
